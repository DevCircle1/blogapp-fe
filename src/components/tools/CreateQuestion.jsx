        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <textarea
              ...
              rows={6}
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all resize-none text-lg"
              maxLength={500}
            />
          ...
          <div className="grid gap-4">
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-4">
              <h3 className="font-semibold text-green-800 mb-2">Tips for great questions:</h3>
