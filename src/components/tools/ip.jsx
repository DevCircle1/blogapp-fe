...
const IPAddressChecker = () => {
  ...
  const seo = (
    <StandaloneToolSeo
      title="What Is My IP Address? Free IP & Location Checker"
      ...
      path="/check-ip"
      category="IP Address Checker"
      intro="See your public IP address and the network information websites can read about your connection."
      steps={[
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      ...
      <ToolContentSections
        light
        heading="About this IP address checker"
        intro="Every device connected to the internet is reachable through an IP address. The one shown above is your public address — the one your router presents to the rest of the internet, and the one every website you visit can see. It is how responses find their way back to you."
        extraParagraphs={[
        ...
        steps={[
          'Open the page — your public IP address is detected automatically.',
          'Check the location, time zone, and provider details listed beneath it.',
          'Copy the address when you need it for an allowlist, a firewall rule, or a support ticket.',
          'Reconnect through your VPN and reload to confirm the address has changed.',
        ]}
        faqs={IP_FAQS}
        related={[
          { to: '/screen-resolution', label: 'Screen Resolution Checker', description: 'Check your viewport size, screen resolution, and pixel ratio.' },
          { to: '/tools/user-agent-parser', label: 'User Agent Parser', description: 'See what your browser reports about itself.' },
          { to: '/tools/password-generator', label: 'Password Generator', description: 'Create strong random passwords in your browser.' },
          { to: '/tools/number-base-converter', label: 'Number Base Converter', description: 'Convert between binary, hex, octal, and decimal.' },
        ]}
      />
    </div>
  );
