  ...
  const tools = [
    {
      ...
      description:
        "Discover your current public IP address instantly. See what information websites can detect about your connection.",
      icon: "🌐",
      link: "/check-ip",
      category: "Network",
    ...
    },
    {
      ...
      description:
        "Calculate profit margins quickly for your business or personal projects. Easy to use with instant results.",
      icon: "💰",
    ...
    },
    {
      ...
      description:
        "Check your current screen resolution and device information. Perfect for developers and designers.",
      icon: "📱",
    ...
    },
    {
      ...
      description:
        "Easily convert plain text into clean, structured HTML code. Perfect for developers, bloggers, and web designers.",
      icon: "📝",
      link: "/text-to-html",
      category: "Web Tools",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Free online tools to help with everyday tasks. No installation
            required.
          </p>
        ...
        <div className="bg-white rounded-xl shadow-md p-8 mt-12">
          ...
          <p className="text-gray-700 mb-4">
            All our tools are designed to be simple, fast, and privacy-focused.
            We don't store your data or require any sign-ups.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div className="text-center p-4">
              ...
              <p className="text-gray-600">
                We don't store your data or track your usage.
              </p>
            </div>
            <div className="text-center p-4">
              <div className="text-4xl mb-3">⚡</div>
              ...
              <p className="text-gray-600">
                Our tools load quickly and work efficiently.
              </p>
            </div>
            <div className="text-center p-4">
              <div className="text-4xl mb-3">💯</div>
