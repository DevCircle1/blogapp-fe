...
export default {
  ...
  categories: {
    Calculator: { slug: 'rechner-uebersicht', name: 'Rechner', blurb: 'Alltagsmathematik: Prozente, Mittelwert, Dreisatz, Brüche, Alter und Einheiten umrechnen.' },
    Finance: { slug: 'finanzrechner', name: 'Finanzrechner', blurb: 'Kredite, Baufinanzierung, Zinsen, Mehrwertsteuer, Margen und die Rechnungen hinter einem kleinen Unternehmen.' },
    Health: { slug: 'gesundheit', name: 'Gesundheit', blurb: 'BMI, Kalorien, Makros, Körperfett, Trinkmenge und Geburtstermin – mit den Grenzen jeder Methode.' },
    Developer: { slug: 'entwicklertools', name: 'Entwicklertools', blurb: 'JSON, Base64, JWT, Regex, Hashes, Farben, CSS und die Referenztabellen, die man ständig wieder sucht.' },
    Security: { slug: 'sicherheit', name: 'Sicherheit', blurb: 'Passwörter erzeugen und prüfen, Karten und E-Mail-Adressen validieren – alles bleibt im Browser.' },
    Text: { slug: 'textwerkzeuge', name: 'Textwerkzeuge', blurb: 'Zählen, Groß- und Kleinschreibung ändern, sortieren, Duplikate entfernen, vergleichen und Texte säubern.' },
